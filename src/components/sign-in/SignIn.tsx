...
export default function SignIn({ user, setLoggedIn }) {
    ...
    return (
        <article className="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-900 pt-40 pb-40">
            <section className="max-w-md w-full space-y-8">
                <section>
                    <img className="mx-auto h-12 w-auto" src="assets/images/edgy-icon.png" alt="Edgy" />
                ...
                <SignInForm user={user} setLoggedIn={setLoggedIn} />
            </section>
        </article>
    );
}